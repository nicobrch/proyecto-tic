      ...
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant='body2'>Crea tu cuenta y empieza a utilizar el dispositivo!</Typography>
          </Box>
          <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
            ...
            <FormControlLabel
              ...
              label={
                <Fragment>
                  ...
                  <Link href='/' passHref>
                    <LinkStyled onClick={e => e.preventDefault()}>términos y condiciones</LinkStyled>
                  </Link>
                </Fragment>
              }
            />
            ...
            <Divider sx={{ my: 5 }}>o utiliza</Divider>
